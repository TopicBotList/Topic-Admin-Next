...
export default function Status() {
  ...
  return (
    <>
      <div className="w-full h-48 flex items-center justify-center bg-blue-900 text-white flex-col py-2 relative">
        <div className="flex flex-col items-center">
          <p className="font-bold text-4xl text-center">Topic Status</p>
          ...
          {statusData.map((server) => (
            <div key={server.name} className="w-full md:w-1/3 px-3 mb-6">
              <div className="bg-black rounded-lg shadow-lg p-4">
                <h2 className="text-lg font-semibold text-blue-500">{server.name}</h2>
                ...
                <p className="mt-2 text-sm text-blue-200">{server.description}</p>
                {server.url && (
