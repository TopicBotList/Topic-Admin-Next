  ...
  return (
    <div className=" bg-transparent h-full w-full flex flex-col justify-center items-center">
      ...
      <div className="flex mt-6 items-center">
        <button onClick={()=> {
            router.replace('/')
        }} className="rounded-lg text-white bg-blue-600 py-3 px-4 min-w-[100px]">Home</button>
        <button onClick={()=>{
            router.back()
        }} className="rounded-lg text-white bg-zinc-900 py-3 px-4 min-w-[100px] ml-3 ">Back</button>
      </div>
    </div>
  );
}