    ...
    <>
      <div className="w-full flex flex-col py-2 relative">
        <div className="flex items-center bg-blue-900/10 p-3">
          <img src={'https://beta.diswidgets.org/ibl.png'} className={'h-[150px] w-[150px] rounded-lg'} />
        ...
        <div className="absolute top-0 right-0 bg-white/50 px-2 py-1 rounded-full">
          <p className="text-sm text-gray-700">Toxic Dev#5936</p>
        </div>
      </div>
    </>
  );
