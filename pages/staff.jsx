    ...
    <>
        ...
        <div className="flex items-center bg-blue-900/10 p-3">
          ...
          <div className="flex flex-col h-[130px] ml-3">
            ...
            <p className="font-semibold text-lg text-white/70">
              Creator Of This Site And BotList
            </p>
      ...
      <div className="w-full flex flex-col py-2">
        <div className="flex items-center bg-blue-900/10 p-3">
          ...
          <div className="flex flex-col h-[130px] ml-3">
            ...
            <p className="font-semibold text-lg text-white/70">
              Canadian | Fullstack Software Dev | He/Him - Elixir - 💍 12-30-20
              | ❤️ 03-22-19 • https://linkcord.bio/TheRealToxicDev
            </p>
            <div className={"h-full"} />
            <div className="flex items-center">
              <FaCrown className="text-3xl text-yellow-400/70" />
      ...
      <div className="w-full flex flex-col py-2">
        <div className="flex items-center bg-blue-900/10 p-3">
          <img
            src={
              "https://cdn.discordapp.com/avatars/899722893603274793/2d7f150e0c587d2c70ddb58fa3193e18.png?size=1024"
            }
            className={"h-[150px] w-[150px] rounded-lg"}
          ></img>
          <div className="flex flex-col h-[130px] ml-3">
            ...
            <p className="font-semibold text-lg text-white/70">
              What if we kissed exchanged our public key? 👉 👈My Profile Python
              ☕ Java https://github.com/zerotwo36
            </p>
            <div className={"h-full"} />
            <div className="flex items-center">
              <FaCrown className="text-3xl text-yellow-400/70" />
